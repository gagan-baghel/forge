    ...
    <div>
      ...
      <div className="p-7">
        {runs.length === 0 ? (
          ...
          <Card className="p-0">
            <div className="grid grid-cols-[auto_1fr_auto_auto_auto] items-center gap-x-4 px-5 py-2.5 text-xs uppercase tracking-wide text-ink-3 border-b border-border">
              <span></span>
              <span>Agent</span>
            ...
            <div className="divide-y divide-border">
              {runs.map((r) => (
                <div key={r.id} className="grid grid-cols-[auto_1fr_auto_auto_auto] items-center gap-x-4 px-5 py-3">
